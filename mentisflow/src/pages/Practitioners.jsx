        ...
        <div className="space-y-2">
          {DIARY_ROWS.map(({ time, name, kind, status }) => (
            <div key={time} className="flex items-center gap-3  border border-slate-100 p-3">
              <div className="flex items-center gap-1.5 text-xs font-semibold text-teal-700 bg-teal-50  px-2 py-1 flex-shrink-0">
                <Clock size={11} />
                {time}
              </div>
  ...
  return (
    <div className="h-[100dvh] overflow-y-auto bg-white text-slate-900">
      ...
      <header className="sticky top-0 z-40 bg-white/85 backdrop-blur-md border-b border-slate-100">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 h-16 flex items-center justify-between">
          <a href={home} className="flex items-center gap-2.5">
            <div className="w-9 h-9  bg-teal-500 flex items-center justify-center shadow-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href={startUrl} className="text-sm font-semibold bg-teal-500 hover:bg-teal-600 text-white px-4 py-2  transition-colors">
              List your practice
            </a>
          </div>
        </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-teal-50/80 via-white to-white">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 pt-14 pb-16 lg:pt-20 lg:pb-20 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div>
            ...
            <a href={startUrl}
              className="inline-flex items-center justify-center gap-2 mt-8 bg-teal-500 hover:bg-teal-600 active:bg-teal-700 text-white font-semibold px-6 py-3.5  transition-colors shadow-lg shadow-teal-500/25">
              List your practice
              <ArrowRight size={17} />
            </a>
      ...
      <section className="max-w-6xl mx-auto px-5 sm:px-8 py-14 lg:py-20">
        <div className="relative overflow-hidden  bg-gradient-to-br from-teal-500 to-teal-700 text-white px-7 py-14 sm:px-14 text-center">
          ...
          <a href={startUrl}
            className="inline-flex items-center justify-center gap-2 mt-8 bg-white text-teal-700 hover:bg-teal-50 font-semibold px-7 py-3.5  transition-colors">
